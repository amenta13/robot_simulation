...
dbuser="u413142534_mickey"
dbpwd="Mantel2023"
dbaddress="srv557.hstgr.io"
dbname="u413142534_baseball"
#make connection
cnx = mysql.connector.connect(user=dbuser, password=dbpwd,
                              host=dbaddress,
                              database=dbname)

print("Sample Data - 1920 NY Yankees")
...
try:
   ...
   #send in SQL
   cursor.execute("""
      select nameFirst,nameLast from Master JOIN Batting using (playerID) where yearID='1920' and teamID='NYA'
   """)
