...
<html lang="en">
    ...
    <body>
        ...
        <h2 style="text-align:center;font-weight:bold;font-size: 25px;color:#084873;">This website pairs with the MyCobot robotic arm from Elephant Robotics to demonstrate web design, database management, and programming. Navigate to the "Controls" page to input commands to the arm over the web or visit the "About" page to learn more.</h2>
